...
<div class=" row">
    ...
    <div class=" container col-9">
        <div class="mt-4">
            <h2 style="text-shadow: 0px 0px 2px #717171;"><img
                    src="https://img.icons8.com/color/47/null/signature.png" />
        ...
        <div class="p-3 mx-auto">
            <form action="{{ route('guardar-determinacion') }}" method="post" novalidate>
                    ...
                    <div class="row align-items-start form-row">
                        <div class="col-md-4">
                            <div class="md-form form-group">
                                ...
                                <div class="input-group mb-6">
                                    ...
                                    {{ $folio = '' }}
                                    @endif
                                    <input type="text" value="{{ $folio }}" id="folio" class="form-control mb-2
                                                    @error('folio')
                        ...
                        <div class="col-md-2">
                            <div class="md-form form-group">
                                ...
                                <input type="text" value="{{ $item->Cuenta }}" class="form-control mb-2
                                                @error('cuenta')
                                                border border-danger rounded-2
                                                @enderror" id="cuenta" name="cuenta" readonly>
                                @error('cuenta')
                                <div class="text-danger text-center">
                        ...
                        <div class="col-md-2">
                            <div class="md-form form-group">
                                ...
                                <input type="text" class="form-control mb-2
                                    @error('clavec')
                                    border border-danger rounded-2
                                    @enderror" id="clavec" name="clavec" value="{{ $item->Clave }}" readonly>
                                @error('clavec')
                                <div class="text-danger text-center">
                        ...
                        <div class="col-md-4">
                            <div class="md-form form-group">
                                ...
                                <input type="text" value="{{ str_replace('¥', 'Ñ', $item->Propietario) }}"
                                    id="propietario" class="form-control mb-2
                                                    @error('propietario')
                                                    border border-danger rounded-2
                                                    @enderror" name="propietario">
                                @error('propietario')
                                <div class="text-danger text-center">
                        ...
                        <div class="col-md-2">
                            <div class="md-form form-group">
                                ...
                                <input type="text" class="form-control mb-2
                                                @error('seriem')
                                                border border-danger rounded-2
                                                @enderror" id="seriem" name="seriem" value="{{ $item->SerieMedidor }}">
                                @error('seriem')
                                <div class="text-danger text-center">
                        ...
                        <div class="col-md-2">
                            <div class="md-form form-group">
                                ...
                                <input type="text" class="form-control mb-2
                                                @error('tipo_s')
                                                border border-danger rounded-2
                                                @enderror" id="tipo_s" name="tipo_s" value="{{ $ts }}" readonly>
                                @error('tipo_s')
                                <div class="text-danger text-center">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <div class="md-form form-group">
                                <input type="text" class="form-control mb-2 text-center
                                                        @error('periodo')
                                                        border border-danger rounded-2
                                                        @enderror" id="periodo" name="periodo"
                        ...
                        <div class="col-md-3">
                            <div class="md-form form-group">
                                ...
                                <input type="text" class="form-control mb-2
                                                @error('razons')
                                                border border-danger rounded-2
                                                @enderror" id="razons" name="razons" value="{{ $giro }}">
                                @error('razons')
                                <div class="text-danger text-center">
                        ...
                        <div class="col-md-4">
                            <div class="md-form form-group">
                                ...
                                <input type="date" class="form-control mb-2
                                                @error('fechad')
                                                border border-danger rounded-2
                                                @enderror" id="fechad" name="fechad" value="{{ old('fechad') }}">
                                @error('fechad')
                                <div class="text-danger text-center">
                    ...
                    <div class="row align-items-start form-row">
                        <div class="col-md-4">
                            <div class="md-form form-group">
                                ...
                                <textarea id="domicilio" rows="6" cols="80" class="form-control mb-2
                                                @error('domicilio')
                                                border border-danger rounded-2
                                                @enderror" name="domicilio">
                                {{ $item->Domicilio }}
                                </textarea>
                                @error('domicilio')
                                <div class="text-danger text-center">
                    ...
                    <table class="table table-hover table-sm table-dark my-2 mx-auto" style="width: 450px">
                        ...
                        <tbody class="table-light">
                            ...
                            <tr>
                                <td>IVA Corriente</td>
                                <td>
                                    <input type="text" name="icorriente" id="icorriente" class="form-control mb-2"
                                        onchange="Suma()" value="${{ number_format($t_adeudo->saldoIvaCor, 2) }}" />
                                </td>
                            </tr>
                            <tr>
                                <td>Atraso</td>
                                <td>
                                    <input type="text" name="atraso" id="atraso" class="form-control mb-2"
                                        onchange="Suma()" value="${{ number_format($t_adeudo->saldoAtraso, 2) }}" />
                                </td>
                            </tr>
                            <tr>
                                <td>Rezago</td>
                                <td>
                                    <input type="text" name="rezago" id="rezago" class="form-control mb-2"
                                        onchange="Suma()" value="${{ number_format($t_adeudo->saldoRezago, 2) }}" />
                                </td>
                            </tr>
                            <tr>
                                <td>Recargos Consumo</td>
                                <td>
                                    <input type="text" name="r_consumo" id="r_consumo" class="form-control mb-2"
                                        onchange="Suma()"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="c_agua" id="c_agua" onchange="Suma()"
                                        value="${{ $intereses->SdoConvAgua }}" class="form-control mb-2
                                                @error('c_agua')
                                                border border-danger rounded-2
                                                @enderror" />
                                    @error('c_agua')
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="r_agua" id="r_agua" onchange="Suma()"
                                        value="${{ $intereses->RecargosConvenio }}" class="form-control mb-2
                                                @error('r_agua')
                                                border border-danger rounded-2
                                                @enderror" />
                                    @error('r_agua')
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="c_obra" id="c_obra"
                                        value="${{ $intereses->SaldoConvObra }}" class="form-control mb-2
                                                @error('c_obra')
                                                border border-danger rounded-2
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="r_obra" id="r_obra"
                                        value="${{ $intereses->RecargosContrato }}" class="form-control mb-2
                                                @error('r_obra')
                                                border border-danger rounded-2
                                                @enderror" onchange="Suma()" />
                                    @error('r_obra')
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="g_ejecucion" id="g_ejecucion"
                                        value="${{ $intereses->GastosEjec }}" class="form-control mb-2
                                                @error('g_ejecucion')
                                                border border-danger rounded-2
                                                @enderror" onchange="Suma()" />
                                    @error('g_ejecucion')
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="o_servicios" id="o_servicios"
                                        value="${{ $intereses->Multas }}" class="form-control mb-2
                                                @error('o_servicios')
                                                border border-danger rounded-2
                                                @enderror" onchange="Suma()" />
                                    @error('o_servicios')
                            ...
                            <tr>
                                <td>Multas</td>
                                <td>
                                    <input type="text" name="multas" id="multas" value="{{ old('multas') }}" class="form-control mb-2
                                                @error('multas')
                                                border border-danger rounded-2
                                                @enderror" onchange="Suma()" />
                                    @error('multas')
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="conv_vencido" id="conv_vencido"
                                        value="{{ old('conv_vencido') }}" class="form-control mb-2
                                                @error('conv_vencido')
                                                border border-danger rounded-2
                                                @enderror" onchange="Suma()" />
                                    @error('conv_vencido')
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="otros_gastos" id="otros_gastos"
                                        value="{{ old('otros_gastos') }}" class="form-control mb-2
                                                @error('otros_gastos')
                                                border border-danger rounded-2
                                                @enderror" onchange="Suma()" />
                                    @error('otros_gastos')
                            ...
                            <tr>
                                <td>Saldo Total</td>
                                <td><input type="text" name="total" id="total" value="{{ old('total') }}" class="form-control mb-2
                                                @error('total')
                                                border border-danger rounded-2
                                                @enderror" readonly />
                                    @error('total')
                ...
                <div class="p-2 rounded-4 mt-3" style=" background-color: #E8ECEF; border: inherit; margin-left: 10px;">
                    <div class="text-white m-2 align-items-end" style="text-align:right;">
                        <span class="bg-success rounded-2 p-2"><img
                    ...
                    <div class="clonar col-md-8 text-center ">
                        <div class="row align-items-start" style="margin-left: 10%">
                            ...
                            <input type="text" value="{{ old('ejecutor.0') }}" id="ejecutor.0" class="form-control mb-2
                                                @error('ejecutor.0')
                                                border border-danger rounded-2
                                                @enderror" name="ejecutor[]">
                            @error('ejecutor.0')
                            <div class="text-danger text-center">
                            ...
                            <button class="btn btn-warning puntero ocultar mt-4"
                                style="width: 5%; position: absolute; margin-left: 50%" type="button">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            ...
                            border border-danger rounded-2
                            @enderror" id="lecturaFacturadaT" name="lecturaFacturadaT">
                        @error('lecturaFacturadaT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            @error('periodoT')
                            border border-danger rounded-2
                            @enderror" id="periodoT" name="periodoT">
                        @error('periodoT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            @error('fecha_vtoT')
                            border border-danger rounded-2
                            @enderror" id="fecha_vtoT" name="fecha_vtoT" placeholder="dia-mes-año">
                        @error('fecha_vtoT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            @error('tarifa1T')
                            border border-danger rounded-2
                            @enderror" id="tarifa1T" name="tarifa1T">
                        @error('tarifa1T')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            @error('sumaTarifasT')
                            border border-danger rounded-2
                            @enderror" id="sumaTarifasT" name="sumaTarifasT">
                        @error('sumaTarifasT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            @error('factorT')
                            border border-danger rounded-2
                            @enderror" id="factorT" name="factorT">
                        @error('factorT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            @error('saldoAtrasoT')
                            border border-danger rounded-2
                            @enderror" id="saldoAtrasoT" name="saldoAtrasoT">
                        @error('saldoAtrasoT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            @error('saldoRezagoT')
                            border border-danger rounded-2
                            @enderror" id="saldoRezagoT" name="saldoRezagoT">
                        @error('saldoRezagoT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            @error('totalPeriodoT')
                            border border-danger rounded-2
                            @enderror" id="totalPeriodoT" name="totalPeriodoT">
                        @error('totalPeriodoT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            ...
                            border border-danger rounded-2
                            @enderror" id="importeMensualT" name="importeMensualT">
                        @error('importeMensualT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            ...
                            border border-danger rounded-2
                            @enderror" id="RecargosAcumuladosT" name="RecargosAcumuladosT">
                        @error('RecargosAcumuladosT')
                        <div class="text-danger text-center">
                            {{ $message }}
                        </div>
